...
class AttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post :create, attachment: { extension: @attachment.extension, nombre: @attachment.nombre, post_id: @attachment.post_id }
    end
  ...
  test "should update attachment" do
    patch :update, id: @attachment, attachment: { extension: @attachment.extension, nombre: @attachment.nombre, post_id: @attachment.post_id }
    assert_redirected_to attachment_path(assigns(:attachment))
  end
